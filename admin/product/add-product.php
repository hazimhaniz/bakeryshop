...
{   $error=false;
	...
	{$mysqli="INSERT INTO product (product_name,product_ingredient,product_size,product_price,product_desc,product_pic,available)VALUES
	       ('$product_name','$product_ingredient',$product_size,$product_price,'$product_desc','$product_pic','$available')";
	...
	<div id="content">
		<div id="lnav">
			...
			<div id="inner-content">
				...
				<div>
					<label>Size(g) :</label><input type="text" name="product_size">
