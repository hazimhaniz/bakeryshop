  ...
  foreach($_SESSION['cart'] as $product_id => $quantity) {
    ...
    if($result){
      ...
      if($obj = $result->fetch_object()) {
        ...
        $query = $mysqli->query("INSERT INTO orders (ProductID, ProductName,  ProductPrice, ProductUnits, total, UsersEmail,Date,status) VALUES('$obj->id', '$obj->name',  $obj->price, $quantity, $cost, '$user',NOW(),'pending')");
